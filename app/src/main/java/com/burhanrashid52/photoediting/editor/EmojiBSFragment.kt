...
import com.burhanrashid52.photoediting.editor.PhotoApp.Companion.photoApp
...
class EmojiBSFragment() : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun getEmojis(context: Context?): ArrayList<String> {
            ...
            try{
            var photoApp = PhotoApp()
            val emojiList =
                photoApp.resources.getStringArray(R.array.photo_editor_emoji)
